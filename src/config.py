...
G = {
    ...
    "outline_top": {"name": "no_outline_top", "type": "checkbox"},
    "outline_bottom": {"name": "no_outline_bottom", "type": "checkbox"},
    "outline_left": {"name": "no_outline_left", "type": "checkbox"},
    "outline_right": {"name": "no_outline_right", "type": "checkbox"},
